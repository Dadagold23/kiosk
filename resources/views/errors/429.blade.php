...
<head>
    ...
    <title>Kiosk - 429 Too Many Requests</title>
    <style>
        body {
        ...
        <div class="error-card card p-4 p-md-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="error-desc">You have sent too many requests in a short period. Please slow down and wait a moment before trying again.</p>
                ...
                <div class="col-lg-6 text-center">
                    <img src="{{ asset('admin-assets/images/error-images/429-error.png') }}" class="img-fluid error-img" alt="429 error illustration">
                </div>
            </div>
        </div>
    </div>
