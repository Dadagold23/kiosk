...
<head>
    ...
    <title>Kiosk - 503 Service Unavailable</title>
    <style>
        body {
        ...
        <div class="error-card card p-4 p-md-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="error-desc">The server is temporarily unable to handle your request due to maintenance or capacity limits. Please try again shortly.</p>
                ...
                <div class="col-lg-6 text-center">
                    <img src="{{ asset('admin-assets/images/error-images/503-error.png') }}" class="img-fluid error-img" alt="503 error illustration">
                </div>
            </div>
        </div>
    </div>
