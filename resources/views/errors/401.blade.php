...
<head>
    ...
    <title>Kiosk - 401 Unauthorized</title>
    <style>
        body {
        ...
        <div class="error-card card p-4 p-md-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="error-desc">Access is denied due to invalid credentials. Please sign in with an authorized account to access this page.</p>
                ...
                <div class="col-lg-6 text-center">
                    <img src="{{ asset('admin-assets/images/error-images/401-error.png') }}" class="img-fluid error-img" alt="401 error illustration">
                </div>
            </div>
        </div>
    </div>
